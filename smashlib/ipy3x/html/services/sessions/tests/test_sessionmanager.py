...
class TestSessionManager(TestCase):
    ...
    def test_bad_get_session(self):
        ...
        session_id = sm.create_session(path='/path/to/test.ipynb',
                                       kernel_name='foo')['id']
        self.assertRaises(
            TypeError, sm.get_session, bad_id=session_id)  # Bad keyword
    ...
    def test_list_sessions(self):
        ...
        sessions = [
            sm.create_session(
                path='/path/to/1/test1.ipynb', kernel_name='python'),
            sm.create_session(
                path='/path/to/2/test2.ipynb', kernel_name='python'),
            sm.create_session(
                path='/path/to/3/test3.ipynb', kernel_name='python'),
        ]
    ...
    def test_bad_update_session(self):
        ...
        session_id = sm.create_session(path='/path/to/test.ipynb',
                                       kernel_name='ir')['id']
        self.assertRaises(TypeError, sm.update_session,
    ...
    def test_bad_delete_session(self):
        ...
        self.assertRaises(
            TypeError, sm.delete_session, bad_kwarg='23424')  # Bad keyword
        self.assertRaises(
            web.HTTPError, sm.delete_session, session_id='23424')  # nonexistant

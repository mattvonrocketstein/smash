...
class directional_link(object):
    ...
    def unlink(self):
        self.source[0].on_trait_change(
            self._update, self.source[1], remove=True)
        self.source = None
        self.targets = []
...
class Type(ClassBasedTraitType):
    ...
    def __init__(self, default_value=None, klass=None, allow_none=True, **metadata):
        ...
        super(Type, self).__init__(
            default_value, allow_none=allow_none, **metadata)
    ...
    def __init__(self, *traits, **metadata):
        ...
        **metadata : any
        ...
        if self._traits and default_value is None:
            # don't allow default to be an empty container if length is
            # specified
            args = None
        super(Container, self).__init__(klass=self.klass, args=args,
                                        allow_none=allow_none, **metadata)
...
class EventfulDict(Instance):
    ...
    def __init__(self, default_value=None, allow_none=True, **metadata):
        ...
        if default_value is None:
            ...
            raise TypeError(
                'default value of EventfulDict was %s' % default_value)
